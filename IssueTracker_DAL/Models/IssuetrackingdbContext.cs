...
public partial class IssuetrackingdbContext : DbContext
{
    public IssuetrackingdbContext()
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source =issuetrackingserver.database.windows.net;initial catalog =issuetrackingdb;user id=demouser;password=Asha@1234");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECAA7A169D4");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__Comments__C3B4DFCA52ABA340");
        ...
        {
            entity.HasKey(e => e.EmpId).HasName("PK__Employee__AF2DBB99CD01CE49");
        ...
        {
            entity.HasKey(e => e.IssueId).HasName("PK__Issues__6C861604002A1306");

            entity.Property(e => e.IssueId).ValueGeneratedNever();
            entity.Property(e => e.Actualdate)
                .HasColumnType("datetime")
                .HasColumnName("actualdate");
            entity.Property(e => e.AssignTo).HasColumnType("numeric(18, 0)");
            ...
            entity.Property(e => e.Description)
                .HasMaxLength(200)
                .IsUnicode(false);
            entity.Property(e => e.Identfiedemp)
                .HasColumnType("numeric(18, 0)")
                .HasColumnName("identfiedemp");
            ...
            entity.Property(e => e.IssueType)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.LinkToPast).HasColumnName("linkToPast");
            ...
            entity.HasOne(d => d.LinkToPastNavigation).WithMany(p => p.Issues)
                .HasForeignKey(d => d.LinkToPast)
                .HasConstraintName("fk_iterationid");
        ...
        {
            entity.HasKey(e => e.Iterationid).HasName("PK__iteratio__EC1F90E38C0F0373");
            ...
            entity.HasOne(d => d.Project).WithMany(p => p.Iterations)
                .HasForeignKey(d => d.Projectid)
                .HasConstraintName("fk_iteration");
        });
        ...
        {
            entity.HasKey(e => e.Projectid).HasName("PK__project__11EC39DD69BA2A33");
